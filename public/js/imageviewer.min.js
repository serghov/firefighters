    ...
    i(function () {
        ...
        return this.container.on("touchstart" + e + " mousedown" + e, function (t) {
            ...
            var n = ("touchstart" == t.type ? "touchmove" : "mousemove") + e,
                a = ("touchstart" == t.type ? "touchend" : "mouseup") + e, o = t.originalEvent,
                s = o.clientX || o.touches[0].clientX, r = o.clientY || o.touches[0].clientY,
        ...
        constructor: r, _init: function () {
            ...
            var e = this, t = e.options, n = !1, o = this.container, r = "." + e._viewerId, h = this.snapHandle,
                m = this.snapImageWrap, v = this.imageWrap, f = new s(m, {
                    sliderId: e._viewerId, onStart: function () {
                        ...
                        var o = e.containerDim, s = e.imageDim.w * (e.zoomValue / 100),
                            r = e.imageDim.h * (e.zoomValue / 100), m = s < o.w ? (o.w - s) / 2 : -s * n / 100,
                    ...
                    sliderId: e._viewerId, onStart: function (i, t) {
                        ...
                        if (!n) {
                            var e = this, t = this.positions[1].x - this.positions[0].x,
            ...
            v.on("mousewheel" + r + " DOMMouseScroll" + r, function (n) {
                if (t.zoomOnMouseWheel && e.loaded) {
                    ...
                    if (s >= 100 && s <= t.maxZoom ? g = 0 : g += Math.abs(a), !(g > u)) {
                        n.preventDefault();
                        var r = o.offset(), h = (n.pageX || n.originalEvent.pageX) - r.left,
                ...
                if (e.loaded) {
                    ...
                    if (t && a) {
                        ...
                        var s = o.offset(),
                            ...
                            c = function (i) {
                                i.preventDefault();
                                var t = i.originalEvent.touches[0], n = i.originalEvent.touches[1],
            ...
            function t() {
                ...
                var h = a(l, s, i - s, 20), d = h / s, g = n.imageDim.w * h / 100, w = n.imageDim.h * h / 100,
                    M = -((e.x - m) * d - e.x), z = -((e.y - c) * d - e.y);
            ...
            var n = this, o = this.options.maxZoom, s = this.zoomValue, r = this.currentImg, h = this.containerDim,
                m = parseFloat(r.css("left")), c = parseFloat(r.css("top"));
            n._clearFrames();
            var l = 0, h = n.containerDim, d = n.imageDim, u = (h.w - d.w) / 2, v = (h.h - d.h) / 2, f = h.w - u,
                p = h.h - v;
            t()
            ...
            var i = this, e = i.currentImg, t = i.container, n = i.snapView, a = e.width(), o = e.height(),
                s = t.width(), r = t.height(), h = n.innerWidth(), m = n.innerHeight();
            ...
            var a = this.currentImg, o = i || this.imageDim.w * this.zoomValue / 100,
                s = e || this.imageDim.h * this.zoomValue / 100,
                r = Math.max(100 * -(t || parseFloat(a.css("left"))) / o, 0),
                h = Math.max(100 * -(n || parseFloat(a.css("top"))) / s, 0),
                m = Math.min(100 * this.containerDim.w / o, 100), c = Math.min(100 * this.containerDim.h / s, 100);
