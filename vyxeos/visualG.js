...
export const visualG = new RODIN.Sculpt();
...
const next2 = new Loader(0.35,  () => {visualG.end(next2Angle + visualG.rotation.y);});
...
const next3 = new Loader(0.35,  () => {visualG.end(next3Angle + visualG.rotation.y);});
